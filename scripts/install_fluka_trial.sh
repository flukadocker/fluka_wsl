...
#        fluka_package_short=fluka$fluka_current_short-linux-gfor64bit-9.3-AA.tar.gz
		fluka_package_short=fluka$fluka_current_short-wsl.tar.gz
#        fluka_package=fluka$fluka_current-linux-gfor64bit-9.3-AA.tar.gz
        fluka_package=fluka$fluka_current-wsl-trial.tar.gz
...
#        wget_return=$(wget --user=$fuid --ask-password  --cipher=DEFAULT:@SECLEVEL=1 https://www.fluka.eu/Fluka/www/htmls/trial/${fluka_package_short})
		 wget_return=$(wget --user=$fuid --ask-password  https://www.fluka.eu/Fluka/www/htmls/trial/${fluka_package_short})
    ...
    if [ ! -e ${fluka_data} ]; then
		...
		#        wget_return=$(wget --user=$fuid --ask-password  --cipher=DEFAULT:@SECLEVEL=1 https://www.fluka.org/packages/${fluka_data})
		        wget_return=$(wget --user=$fuid --ask-password   https://www.fluka.eu/Fluka/www/htmls/trial/${fluka_data})
